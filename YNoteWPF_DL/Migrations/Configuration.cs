namespace YNoteWPF_DL.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<YNoteWPF_DL.YNoteDbContext>
    {
        ...
        protected override void Seed(YNoteWPF_DL.YNoteDbContext context)
        {
